...
//Testing curl: curl -X POST http://localhost:8080/github-events -d "TestingThisNewStuff"
//Review your logs inside container: docker exec -it githubWebhookEvents tail -f githubeventslog.log
